 //code line 2- 48 56-83 are inspired from profressor https://github.com/carolinebarriere/carolinebarriere.github.io/blob/master/SEG3125-Module6-SurveyAnalysis/surveyController.js
 // required packages
// required packages
...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        ...
        var class_new = readData("class_new");
        var sports = readData("sports");
        var date = readData("date");
        var car = readData("car");
        var rating = readData("rating");
        var comments = readData("comments");
        res.render('showResults', {results: [name,email ,class_new, sports,car,rating,date,comments]});
        console.log([name,email ,class_new, sports,car,rating,date,comments]);
    });
    ...
    app.post('/niceSurvey', urlencodedParser, function(req, res){
        ...
        for (var key in json){
            ...
            if ((key === "class_new") && (json[key].length === 2)){
